...
from Pygame.classes.Sprite import Sprite
...
class Sprites:
    def __init__(self):
        self.spriteCollection = self.loadSprites(
            [
                "./Pygame/sprites/Mario.json",
                "./Pygame/sprites/Goomba.json",
                "./Pygame/sprites/Koopa.json",
                "./Pygame/sprites/Animations.json",
                "./Pygame/sprites/BackgroundSprites.json",
                "./Pygame/sprites/ItemAnimations.json",
                "./Pygame/sprites/RedMushroom.json"
            ]
        )

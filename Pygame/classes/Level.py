...
from Pygame.classes.Sprites import Sprites
from Pygame.classes.Tile import Tile
from Pygame.entities.Coin import Coin
from Pygame.entities.CoinBrick import CoinBrick
from Pygame.entities.Goomba import Goomba
from Pygame.entities.Mushroom import RedMushroom
from Pygame.entities.Koopa import Koopa
from Pygame.entities.CoinBox import CoinBox
from Pygame.entities.RandomBox import RandomBox
...
#        self.MakeMap = MakeRandomMap()
 ...
 #       self.MakeMap.write_Json()
        with open("./Pygame/levels/{}.json".format(levelname)) as jsonData:
